...
if(isset($_POST['additem']) && $_POST['additem']=='Tambah'){
 ...
 $hpp = $_POST['hpp'];
	...
	$crt_date = date("Y-m-d H:i:s") ;
	    $harga = $_POST['harga'];
	    $merk = $_POST['merk'];
	$sql = "INSERT INTO item	(id,item_grp_id,nama,barcode,satuan_id,hpp,aktif,crt,crt_date,harga,merk) VALUES('$id','$nk','$nama','$barcode','$satuan','$hpp','$aktif','$crt','$crt_date','$harga','$merk')";
