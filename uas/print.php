<html>
    ...
    <body>
        <div class="container">
            ...
            <a class="btn mb-3 col-2 text-light" href="index.php" style="background-color:#8b008b;">Kembali</a>
            <button class="btn mb-3 text-center col-2" id="cetak" style="background-color:#cca9dd;">Print</button>
            </div>
